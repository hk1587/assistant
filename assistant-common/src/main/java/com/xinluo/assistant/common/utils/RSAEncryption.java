...
public class RSAEncryption {
    ...
    public static String RSADecode(PrivateKey key, String encodedText) {
        try {
            ...
            System.err.println("----------------有未加密内容尝试解密-------------------"+encodedText);
            e.printStackTrace();
        }
        return null;
    }
...
//
//        StringBuffer aa = new StringBuffer("哈");
//
...
//
//        String ciphertext = RSAEncode(getPublicKey(publicKey), aa.toString());
//
